...
def yes():
    ...
    def bmi_status(bmi):
        if bmi < 18.5:
            return "Underweight", "red", [1, 0, 0]
        elif bmi < 25:
            return "Normal", "green", [0, 1, 0]
        elif bmi < 30:
            return "Overweight", "orange", [0, 0, 1]
        else:
            return "Obese", "red", [0, 0, 1]
    def draw_bmi_chart(frame, highlight):
        ...
        wedges, _ = ax.pie(values,startangle=180,colors=colors,wedgeprops={"width": 0.4})
    ...
    def calculatebmi():
        ...
        if a>18:
            ...
            try:
                ...
                draw_bmi_chart(chart_frame, highlight)
